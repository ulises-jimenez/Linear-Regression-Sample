...
y, X = patsy.dmatrices('Sales ~ TV', data = advertising, return_type='dataframe') #use this matrix builder to apply transformations and interaction terms
Xalone = advertising['TV']
...
def residuals(test): # plots residuals and residuals histogram
...
model(Xalone, y, 'Tv advertisement Spending', 'Sales', 'Advertisement spending effects')
